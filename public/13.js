...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    procesarPago: function procesarPago() {
      ...
      var session_id = ''; // Control de datos de envío
      ...
      if (!this.shippingInformation) {
        ...
        this.errorDatosEnvio = true; // Tiempo de aparicion del mensaje
      ...
      var shippingInformation = this.shippingInformation;
      var carrito = this.$store.getters.getCart; //Creacion del pedido
      ...
      axios.post('/api/order', {
        ...
        var data = {
          'total_price': _this2.precioTotal,
        ...
        axios.post("/api/checkOutSession", data).then(function (res) {
          ...
          console.log(res.data); // Redirect to Stripe checkout
